...
- Added `.env.example`, MLOps folder structure, and local artifact/data ignore rules.
- Added documentation for academic context, data, model assumptions, MLOps, experiments, and architecture.
- Added notebook splitting automation while retaining the original notebook.
